...
def media_mix_model(
  ...
  # numpyro.plate: 条件付き独立のサンプリングをベクトル化する機能
  # https://www.hellocybernetics.tech/entry/2020/05/07/235349
  # おそらくここでは事前分布を生成していると思われる
  ...
  if weekday_seasonality:
    ...
    if transform_function == "carryover" and transform_kwargs and "number_lags" not in transform_kwargs:
      ...
      transform_kwargs = {"number_lags": 13 * 7}
  # numpyro.deteministic: 決定論的な指定を行うらしい。
